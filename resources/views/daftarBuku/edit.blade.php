            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Edit Data Daftar Buku</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <div class="row">
                        ...
                        <hr>
                        <form class="needs-validation" novalidate="" method="POST" action="{{ route('daftarBuku.update', $daftarBukus->_id) }}">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label class="form-control-label" for="judul_buku">Judul Buku</label>
                                    <input type="text" class="form-control" name="judul_buku" id="judul_buku" placeholder="Judul Buku" required="" value="{{ $daftarBukus->judul_buku }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="pengarang" id="pengarang" placeholder="Pengarang" required="" value="{{ $daftarBukus->pengarang }}">
                                    <div class="valid-feedback">
                                        Bagus!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="kategori" id="kategori" placeholder="Kategori" required="" value="{{ $daftarBukus->kategori }}">
                                    <div class="valid-feedback">
                                        Bagus!
                                    </div>
                                    <div class="invalid-feedback">
