            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Tambah Data Stok Buku</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <div class="row">
                        ...
                        <hr>
                        <form class="needs-validation" novalidate="" method="POST" action="{{ route('stokBuku.store') }}">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="jumlah_buku" id="jumlah_buku" placeholder="Jumlah Buku" required="">
                                    <div class="valid-feedback">
                                        Bagus!
                                    </div>
                                    <div class="invalid-feedback">
