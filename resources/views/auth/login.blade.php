...
<head>
  ...
  <title>Dyperpus &mdash; Login</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-4">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Selamat datang di dyperpus, silahkan login untuk aktivitas selanjutnya!.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="text-center text-muted mb-4">
                <span class="sub-login">Login to your account</span>
              </div>
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-center text-muted mb-4">
                  <span class="sub-login">Tidak memiliki akun? <a href="{{ url('register') }}">Daftar Sekarang</a></span>
                </div>
              </form>
              @if ($errors->has('email'))
                <div class="alert-box">
